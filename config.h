...
/** generic settings **/
static const char col_main[] = "#ff0e95";
static const char col_aux[]  = "#444444";
...
#define FOCUS           col_main  /* focused window border color   */
#define UNFOCUS         col_aux   /* unfocused window border color */
...
static const char *menucmd[] = { "dmenu_run", "-nb", "#000000", "-nf", col_aux, "-sb", col_main, "-sf", "#000000", "-nhb", "#000000", "-nhf", col_main, "-shb", col_main, "-shf", "#1a000e", NULL };
